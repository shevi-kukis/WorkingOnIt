...
def analyze_resume(resume_file_path: str) -> list:
    ...
    # הגדרת הפרומפט
    prompt = (
        " נתח את קובץ קורות החיים וספק בדיוק 10 שאלות לראיון עבודה על בסיס התוכן שבו שים לב לשאול שאלות של ידע מקצועי,. "
