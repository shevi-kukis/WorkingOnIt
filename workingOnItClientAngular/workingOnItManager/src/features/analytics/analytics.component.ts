...
// // Removed duplicate import of MatSelectModule
...
// import type { AllUserScores } from "../../core/models/interview.model"
...
//   standalone: true,
//   imports: [CommonModule, MatCardModule, MatSelectModule, MatFormFieldModule, CommonModule,
...
//       title: {
//         display: true,
//         text: "Individual User Performance",
//       },
//     },
//     scales: {
//       y: {
...
//         const average = userScores.reduce((sum, score) => sum + score.score, 0) / userScores.length
//         userLabels.push(user.fullName)
//         userAverages.push(Math.round(average))
//       }
//     })
